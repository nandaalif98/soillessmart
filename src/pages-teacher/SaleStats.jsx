...
import DiagramPenjualan from '../components-teacher/DiagramPenjualan'

export default function SaleStats(props, {haveCourse = true}) {
    ...
    return (
      <div className='ml-80 mr-16 my-16'>
        <div className='flex flex-col gap-10'>
          ...
          <h1 className='text-tertiary text-center my-40'><i>Anda tidak memiliki course, silahkan unggah course terlebih dahulu untuk melihat statistik penjualan.</i></h1>
        </div>
      </div>
    )
  }
