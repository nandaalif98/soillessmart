...
export default function ManageCourse(props, {haveCourse = true}) {
  ...
  } else { // kalo teacher belom upload course
    return (
      <div className='ml-80 mr-16 my-16'>
        <div className='flex flex-col gap-10'>
          <div className='flex justify-start gap-6 p-16 w-full rounded-3xl shadow-2xl bg-gradient-to-r from-green-400 to-blue-500'>
          ...
          <h1 className='text-tertiary text-center my-40'><i>Anda tidak memiliki course, silahkan unggah course terlebih dahulu</i></h1>
        </div>
      </div>
    )
  }
